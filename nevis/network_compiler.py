...
class NevisCompiler:
    ...
    def generate_nevis_connection(self, conn_obj, conn_params, index_pre, index_post):
        ...
        output_hardware = Synapses_Floating(
            ...
            n_output        = self.comp_args["n_output"],
